...
const UpdateProject = () => {
    ...
    return (
        <PageWrapper className="p-10 md:p-24 mt-5 w-screen flex flex-col items-center justify-center">
            <h1 className="text-3xl text-gray-200 font-bold mb-10"> Create Project </h1>
            <form className="w-full max-w-lg">
                    ...
                    formData.chips.map((_, index) => (
                        <div key={index} className="flex flex-wrap -mx-3 mb-6">
                            <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                ...
                                <input
                                    className="appearance-none block w-full bg-gray-200 text-gray-900 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus-none focus:bg-white focus:border-gray-500"
                                    id={`iconType-${index}`}
                                    type="text"
                ...
                <button
                    className="shadow bg-green-900 w-full hover:bg-green-400 focus:shadow-outline focus:outline-none text-white hover:text-black font-bold py-2 px-4 rounded"
                    type="button"
